...
class CreateChoreViewController: UIViewController {
    ...
    @IBAction func createChoreButtonPressed(_ sender: Any) {
        ...
        var newChore = Chore(chore_title: choreTitle!, assignor: (currentUser?.nickname)! , assignee: userResponsible!, time_assigned: date, house: currentHouse.houseID!, description: choreDescription!)
